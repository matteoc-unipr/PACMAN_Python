...
'''
REPLACE DOWN HERE THE DIRECTORY WITH YOUR DIRECTORY OF THE FONT !!!

'''  

def draw_text(txt: str, pos: (int, int), size: int) -> None:
    font = pg.font.Font('C:\\Users\\Utente\\Desktop\\UNIVERSITA\\INFORMATICA\\PROGRAMMI\\PACMAN\\emulogic.ttf', int(size))
